...
class EstudianteGrupoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estudiante Grupo creado exitosamente!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estudiante Grupo modificado exitosamente!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estudiante Grupo eliminado exitosamente!');
    }
}